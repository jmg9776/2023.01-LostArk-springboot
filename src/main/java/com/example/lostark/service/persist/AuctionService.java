...
import com.example.lostark.repository.AuctionProductRepository;
...
public class AuctionService<E extends AuctionProduct> extends DataAccessAbstract<E> {
    private final AuctionProductRepository repository;
